...
Detalhamento do método por trás do conjunto de dados descrito em
[`DICIONARIO-DE-DADOS.md`](DICIONARIO-DE-DADOS.md): proveniência, delineamento
amostral, formalização das medidas derivadas, limitações e referências.
